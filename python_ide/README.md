...
3. Создание репозитория проекта на `GitHub`
   ...
   * Добавьте участников команды, если необходимо _(на странице репозитория вкладка Settings > Colloborators. Пригшлашение можно принять в Github или на эл. почте)_
