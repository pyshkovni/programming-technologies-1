...
Здесь приведены необходимые ссылки без лишних объяснений 👇

{% list tabs %}

- Полезные ссылки по дисциплине

  [Таблица итогов](https://docs.google.com/spreadsheets/d/1rtYymujWHRgvxA8Lqms0MuJ0MtaOHghhTcO63BTDWwA/edit?usp=sharing)

  [Страница курса Python base](https://pyshkovni.github.io/python_base/)

  *Тестирование курса (позже)*

  *Сдача заданий codewars (позже)*

  [Профиль github с кейсами](https://github.com/pyshkovni?tab=repositories)
...
{% note info "50 процентов к 2025 году…" %}
...
Кейсы и необходимые файлы для их прохождения можно найти в профиле `github` преподавателя https://github.com/pyshkovni?tab=repositories
